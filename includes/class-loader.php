...
/**
 * The loader is used to maintain a list of all hooks that are registered throughout
 * the plugin, and register them with the WordPress API.
 * Calling the run() function to executes the list of actions and filters.
 *
 * *** We generally do not expect to need to edit this file. ***
 *
 * @package    MyPlugin
 * @subpackage MyPlugin/includes
 * @author     Tom McFarlin & Devin Vinson https://wppb.me/
 */
class WPPB_Loader {
