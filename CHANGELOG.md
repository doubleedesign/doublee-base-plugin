...
- Feature: Specialised custom post type "CPT index" to allow for custom post types that meet certain criteria to be treated like pages in specific contexts, such as ACF post object and relationship fields. See the [README](README.md#cpt-index-post-type) for details.
...
- Cleanup: Remove unused fields from my brief experimentation with ACF Extended
